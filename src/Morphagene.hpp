...
struct ReelDisplay;
struct MorphageneWidget;

/*
 * Morphagene VCV Rack Module
 *
...
struct MorphageneWidget : ModuleWidget
{
  Morphagene* module = nullptr;

  MorphageneWidget(Morphagene* module);
